...
(() => {
  ...
  const places = [
    ...
    {id:'bryce', short:'Bryce Canyon', name:'Bryce Canyon', location:'Utah, USA', type:'Dark-sky wonder', lon:-112.167, lat:37.593, description:'Sculpted hoodoos fill the amphitheaters by day. After sunset, this International Dark Sky Park opens a window onto a sky full of stars.', alt:'The Milky Way photographed at Bryce Canyon National Park', url:'https://www.nps.gov/brca/index.htm'},
